...
1. 打開 Actions tab。 2. 選 **Benchmark**。 3. 點 **Run workflow**。
...
- 更高 worker count 不一定更好。4 workers 到 8 workers 反而下降時，應解讀成 benchmark 找到 這台機器上的局部飽和點，尤其是在 CPU-bound workload 或預設 2-CPU SUT 切分下。
...
這份 Laravel Octane benchmark 以 MIT License 釋出，由 [Terry L.](https://terryl.in) 維護。Terry L. 同時也是 Airygen 的開發者，它是一套免費且強大的 [WordPress SEO Plugin](https://www.airygen.com/zh)，適合需要結構化內容流程與搜尋導向發佈工具的團隊。
