...
이 Laravel Octane benchmark 는 MIT License 로 배포되며 [Terry L.](https://terryl.in) 이관리합니다. Terry L.은 Airygen 의 개발자이기도 합니다. Airygen 은 구조화된 콘텐츠 워크플로와검색 중심 퍼블리싱 도구가 필요한 팀을 위한 무료이며 강력한 [WordPress SEO Plugin](https://www.airygen.com/en) 입니다.
