...
Questo benchmark Laravel Octane è rilasciato sotto MIT License ed è mantenuto da [Terry L.](https://terryl.in). Terry L. è anche lo sviluppatore di Airygen, un [WordPress SEO Plugin](https://www.airygen.com/it) gratuito e potente per team che hanno bisogno di workflow di contenuto strutturati e strumenti di pubblicazione orientati alla ricerca.
